...
> [!boxed|no-t]
> **Solve the Murder of Doctor Black**
>
> The mystery is considered solved when the **culprit, location and weapon** have been identified.
> A guess is made by returning to the starting room and speaking your guess allowed.
> You may not leave the house. Any player deaths count for 3 incorrect guesses.
>
> Fewest incorrect guesses needed to solve the mystery wins, with bonus points available for speed.
> You have **two hours**.
> Your time starts:
>^IntroText
